...
namespace RegPwn
{
    public class WindowsApi
    {
        ...
        public static extern int RegDeleteKey(uint hKey, string lpSubKey);
        ...
        [DllImport("advapi32.dll", CharSet = CharSet.Unicode)]
        public static extern uint RegDeleteKeyW(IntPtr hKey, string lpSubKey);
      ...
      out IntPtr phkResult);
        ...
        public const int REG_OPTION_OPEN_LINK = 0x0008;
        ...
        public const int TokenAuditPolicy = 16;
        public const int TokenOrigin = 17;
        ...
        public const uint REG_LINK = 0x00000006;
        [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
